...
public class Analysis {
    ...
    private final String BUBBLE_SORT_START_MERGE = "Bubble sort from start with half division";
    private final String BUBBLE_SORT_END_MERGE = "Bubble sort from end with half division";
    private final String QUICK_SORT_MERGE = "Quick sort with half division";
    private final String STANDARD_SORT_MERGE = "Standard sort with half division";

    private final String SORTED_ARRAY = "Sorted array";
    private final String SORTED_ARRAY_X = "Sorted array with element X at the end";
    private final String REVERSE_ARRAY = "Sorted and reversed array";
    private final String RANDOM_ARRAY = "Random filled array";

    public Map<String, Long> startAnalysis(int length, int elementX) {
